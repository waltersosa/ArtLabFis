...
\autores{[Autores anonimizados para revisi\'on por pares]}
\adscripcionautor{[Afiliaci\'on institucional omitida para revisi\'on por pares]}

%%Datos para referencias
\newcommand{\apellido}{[Anonimizado]}% Apellido o apellidos para referencia 
...
\newcommand{\autor}{[Anonimizado]}%autor para propiedades del pdf
...
[Contenido omitido para revisi\'on por pares]
%========================================================
